...
// export const distance = (a, b, mode = "3d") => {
//   const dx = a.lng - b.lng;
//   const dy = a.lat - b.lat;
...
//   // extra weight for floor transition
//   if (mode === "3d") {
//     const floorPenalty =
//       Math.abs((a.floor || 0) - (b.floor || 0)) * 15;

//     return horizontalDistance + floorPenalty;
//   }
...
//     if (
//       allowedFloors &&
//       !allowedFloors.includes(node.floor)
//     ) {
//       return;
//     }
...
//       // skip blocked nodes
//       if (unselectedNodes.includes(n)) continue;

//       // if selected nodes exist,
//       // floor-changing nodes must belong to selected set
//       const currNode = parseNode(curr);
//       const nextNode = parseNode(n);
